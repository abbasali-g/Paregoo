...
#Region "Manager"
        ...
        Public Sub SendEmail(ByVal EmailClass As EmailClass)

            Clear()

            Try

                Dim client As New SmtpClient(EmailClass.SmtpClient)
                If Not String.IsNullOrEmpty(_Port) Then
                    client.Port = _Port
                End If

                client.UseDefaultCredentials = False
                client.Credentials = New System.Net.NetworkCredential(EmailClass.NetworkCredential_Mail, EmailClass.NetworkCredential_Pass)

                client.EnableSsl = EmailClass.EnableSsl ' true in gmail and yahoo
                ...
                msg.From = New MailAddress(EmailClass.From_Email, EmailClass.DisplayName)
                msg.ReplyTo = New MailAddress(EmailClass.From_Email, EmailClass.DisplayName)

                msg.To.Clear()
                msg.To.Add(EmailClass.To_Email) ' separat with camma .msg.To.Add(New MailAddress(Email.To_Email))
                msg.Subject = EmailClass.Subject
                msg.SubjectEncoding = System.Text.Encoding.UTF8
                msg.Body = EmailClass.Body
