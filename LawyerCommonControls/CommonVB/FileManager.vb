...
#Region "Methods"
        ...
        '' ''    'Dim newFileName As String = filefullName & "1"
...
#End Region
        ...
        Public Shared ReadOnly Property GetNewVersionPath() As String
            ...
            Get
                Try
                    '' ''Dim s As Setting.SettingCollection = Setting.SettingManager.GetSettingsByName("NewVersionsApplication@2")

                    '' ''If s IsNot Nothing AndAlso s.Count > 0 Then

                    '' ''    Return App_RootPath() + s.Item(0).settingValue
        ...
        '' ''        ''''Dim fPath As String = "C:" + "\emptyWord.docx"
        '' ''        Try
