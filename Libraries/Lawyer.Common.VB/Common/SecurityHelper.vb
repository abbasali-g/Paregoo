...
Namespace Common
    ...
    Public Class SecurityHelper : Inherits Global.Common.Security.SecurityHelper
        ...
        End Function
        Public Shared Shadows Function EncryptUTF(ByVal PlainText As String) As String

            Return Global.Common.Security.SecurityHelper.EncryptUTF(PlainText, Key)
        ...
        Public Shared Shadows Function DecryptUTF(ByVal EncryptedText As String) As String
            ...
            Try
                ...
                Return Global.Common.Security.SecurityHelper.DecryptUTF(EncryptedText, Key)
