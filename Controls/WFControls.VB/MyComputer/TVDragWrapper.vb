...
Imports WFControls.VB.ShellDll
...
#Region "   Private Fields"
    ...
    Private m_LastTarget As WFControls.VB.ShellDll.IDropTarget     'Of most recent Folder dragged over
...
#End Region
    ...
    Public Function DragEnter(ByVal pDataObj As IntPtr, _
                        ...
                        Implements WFControls.VB.ShellDll.IDropTarget.DragEnter
    ...
    Public Function DragOver(ByVal grfKeyState As Integer, _
                                ByVal pt As POINT, _
                                ByRef pdwEffect As Integer) As Integer _
                        Implements WFControls.VB.ShellDll.IDropTarget.DragOver
    ...
    Public Function DragLeave() As Integer Implements WFControls.VB.ShellDll.IDropTarget.DragLeave
    ...
    Public Function DragDrop(ByVal pDataObj As IntPtr, _
                                ...
                                ByVal pt As POINT, _
                                ByRef pdwEffect As Integer) As Integer _
                            Implements WFControls.VB.ShellDll.IDropTarget.DragDrop
