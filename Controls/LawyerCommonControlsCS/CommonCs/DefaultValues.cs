...
namespace LawyerCommonControlsCS.CommonCS
{
    public class DefaultValues
    {
       ...
       public static String AutoConfigExe = App_ParentDir() + "\\ConfigMysql.exe";
        ...
        //}
        //public static String App_ParentPath()
        //{
        //    string dPath = string.Empty;

        //    try
        //    {
        //        dPath =System.IO.Path.GetDirectoryName(Environment.GetCommandLineArgs()[2]) + "\\DefaultFolders";
