...
using System.Xml;
using System.IO;
namespace LawyerCommonControlsCS.ConfigFile
{
   ...
   public  class Config
    {
        ...
        public string LPort
        {
            ...
            {
                if (Decrypt)
                    _LPort =  LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _LPort = value;
            }
        }
        ...
        public string LIP
        {
            ...
            {
                if (Decrypt)
                    _LIP = LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _LIP = value;
            }
        }
        ...
        public string LUserName
        {
            ...
            {
                if (Decrypt)
                    _LUserName = LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _LUserName = value;
            }
        }
        ...
        public string LPassword
        {
            ...
            {
                if (Decrypt)
                    _LPassword = LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _LPassword = value;
        ...
        public string Port
        {
            ...
            {
                if (Decrypt)
                    _Port = LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _Port =value ;
            }
        }
        ...
        public string UserName
        {
            ...
            {
                if (Decrypt)
                    _UserName = LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _UserName = value;
            }
        }
        ...
        public string Password
        {
            ...
            {
                if (Decrypt)
                    _Password = LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _Password = value;
        ...
        public string IP
        {
            ...
            {
                if (Decrypt)
                    _IP = LawyerCommonControls.CommonVB.SecurityHelper.Decrypt(value, key);
                else
                    _IP = value;
            }
        }
        ...
        {
            return LawyerCommonControls.CommonVB.SecurityHelper.Encrypt(str, key);
        }
        ...
        public static Config CreateDefultXml(string filePath)
        {
            ...
            XmlElem.InnerText = LawyerCommonControls.CommonVB.SecurityHelper.Encrypt(CommonCS.DefaultValues.DefaultIP, k);
            Root.AppendChild(XmlElem);

            XmlElem = XmlDoc.CreateElement("PO");
            XmlElem.InnerText = LawyerCommonControls.CommonVB.SecurityHelper.Encrypt(CommonCS.DefaultValues.DefaultPort, k); 
            Root.AppendChild(XmlElem);

            XmlElem = XmlDoc.CreateElement("U");
            XmlElem.InnerText = LawyerCommonControls.CommonVB.SecurityHelper.Encrypt(CommonCS.DefaultValues.DefaultUser, k);
            Root.AppendChild(XmlElem);

            XmlElem = XmlDoc.CreateElement("P");
            XmlElem.InnerText = LawyerCommonControls.CommonVB.SecurityHelper.Encrypt(CommonCS.DefaultValues.DefaultPass, k);
            Root.AppendChild(XmlElem);
