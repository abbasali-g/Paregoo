...
using LawyerCommonControls .LawyerError;
...
namespace LawyerCommonControlsCS.ResoreBackup
{
    public partial class BackRestore : UserControl
    {
        public BackRestore()
        {
         ...
         LawyerCommonControlsCS.ConfigFile.Config currentConfig = null;
        ...
        {
            lblMessage.Text = string.Empty;
            string computerName = txtIPAddress.Text;
            ...
            createBackupRestoreParameter(txtIPAddress.Text, txtDatabaseName.Text, txtUserName.Text, txtPassword.Text, port);
        ...
        {
            string fileName = CommonCS.DefaultValues.App_ParentDir() + "\\";
            ...
            try
            {
                ...
                if (rdBackup.Checked == true)
                {
                    ...
                    parameters = string.Format("{0} {1} {2} {3} {4} {5}", txtIPAddress.Text, port, txtUserName.Text, txtPassword.Text, databaseName, txtPath.Text);
        ...
        private bool IsAttachDataBase()
        {
            MySqlConnection con = new MySqlConnection(string.Format("server={0};Port={1};uid={2}; pwd={3};database=mysql;", txtIPAddress.Text, txtPort.Text, txtUserName.Text, txtPassword.Text));
        ...
        public void SetInitial(LawyerCommonControlsCS.ConfigFile.Config c, bool IsRestore)
        {
            ...
            if (currentConfig != null)
            {
                ...
                if (IsRestore)
                {
                    ...
                    grpBackRestore.Enabled = false;
                    txtPath.Text = CommonCS.DefaultValues.RestorePath;
                }
                //unzip & restore
                else
